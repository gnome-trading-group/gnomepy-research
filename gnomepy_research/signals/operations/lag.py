...
class LagOperation(Operation):
    """Returns the signal's value from n ticks ago."""
...
def Lag(signal, n: int = 1):
    """Apply n-tick lag to any signal, preserving its type."""
    return apply(LagOperation(n=n), signal)
